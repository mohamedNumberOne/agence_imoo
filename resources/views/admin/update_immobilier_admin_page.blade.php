                            ...
                            <form class="row g-3" method="post"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="transaction" class="form-select" name="transaction" required>
                                        ...
                                        <option value="{{ $immobilier-> transaction  }}" selected >  {{ $immobilier-> transaction  }} </option>
                                        @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select id="Daira" class="form-select" name="daira">
                                        ...
                                        @else
                                        <option selected value=" {{ $daira->id }}"> {{ $daira->name }} </option>
                                        @endif
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" placeholder="Address..."
                                        value="{{ $immobilier->adresse   }}" name="adresse">
                                    @error('adresse')
                                    <span class="text-danger text-center"> {{ $message }} </span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div>
                                        ...
                                        <img src="{{ asset('storage/' . $img -> path_img ) }}" alt="image" width="70px"
